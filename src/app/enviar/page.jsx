    ...
    return (<>
        ...
        <div
            ...
            <div className="gap-2 flex items-center">
                ...
                <label
                    htmlFor="img"
                    className={`px-2 py-1 rounded-sm text-zinc-100 ${fileName ? "bg-pink-500" : "bg-zinc-400"} ${docValue === "" ? "cursor-not-allowed" : "cursor-pointer"}`}
                >
        ...
        <div className="flex gap-2 h-full">
            <div className="flex flex-col bg-indigo-200 flex-1 rounded-sm justify-end items-end">
            ...
            <div className="flex flex-col bg-gray-100 flex-1 rounded-sm">
