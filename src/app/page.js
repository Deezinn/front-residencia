  ...
  return (
    <div className="p-20">
      ...
      <div className="flex gap-4 pl-2 mt-4">
        <a href="https://github.com/Deezinn/front-residencia" target="_blank" className="bg-pink-500 hover:bg-pink-600 text-white font-semibold py-2 px-3 rounded-sm transition-colors duration-300 flex items-center gap-1">
